...
export interface Config {
  ...
  fallbackLocale: ('false' | 'none' | 'null') | false | null | 'sk' | 'sk'[];
  globals: {
...
export interface Product {
  ...
  title: string;
  /**
   * Používa sa pre URL adresy, napr. /automaty/air-hockey
   */
  slug?: string | null;
  /**
   * Voliteľné — napr. „Športové automaty“, „Stolové hry“.
   */
  ...
  gallery?:
    ...
    | null;
  /**
   * Voliteľné — priamy odkaz na video (MP4), zobrazí sa v galérii detailu.
   */
...
export interface Reference {
  ...
  author: string;
  /**
   * Napr. „firemná párty“ alebo „HR manažérka, XYZ s.r.o.“ — vyplňte len to, čo môžeme zverejniť.
   */
  event?: string | null;
...
export interface SiteSetting {
  id: number;
  /**
   * Zobrazuje sa v hlavičke a pätičke. Skutočné logo nahradíme, keď bude dodané.
   */
